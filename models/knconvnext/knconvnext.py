# from https://github.com/pytorch/vision/blob/main/torchvision/models/convnext.py
# modification: KNConv layers in downsampling sections
        ...
        for cnf in block_setting:
            ...
            if cnf.out_channels is not None:
                ...
                layers.append(
                    nn.Sequential(
                        torch.nn.ReLU(),
                        KNConv2d(cnf.input_channels, cnf.out_channels,
                                 kernel_size=(2, 2), stride=(2, 2), padding=(0, 0), dropout_p=0.1, bias=True),
                    )
                )
...
def knconvnext_tiny(*, weights: Optional[ConvNeXt_Tiny_Weights] = None, progress: bool = True, **kwargs: Any) -> ConvNeXt:
...
def knconvnext_base(*, weights: Optional[ConvNeXt_Base_Weights] = None, progress: bool = True, **kwargs: Any) -> ConvNeXt:
